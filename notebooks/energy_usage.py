...
Original file is located at
    https://colab.research.google.com/drive/1GY_IyQyHIbK49sjj0GSEP1eunEyKSOug
...
data = pd.read_csv("./content/energy_usage.csv")
...
grid_search = GridSearchCV(estimator = reg, param_grid = param_grid, cv = 5, n_jobs = None , scoring='r2' , verbose=2)
